...
/* =========================================================
   ...
   ========================================================= */
const CONTATO = 'mailto:lucas@asimov.academy';
...
const HISTORIA = [
  ...
  { // folha 2 — frente: o que faço hoje / verso: crachá freelancer
    ...
    verso: [
      ...
      { tipo: 'nota', x: 30, y: 350, rot: -1, tam: 'p', texto: 'design, estratégia e boas conversas.' },
    ],
  },
  { // folha 3 — frente: o que fiz / o que aprendi. verso: Asimov + projeto
    ...
    verso: [
      ...
      { tipo: 'polaroid', x: 44, y: 130, rot: -3, wide: true, img: 'assets/img/thumb-projeto.webp', legenda: 'aprendendo e ensinando', fita: ['tr'] },
    ],
  },
